...
\end{center}
\noindent{\bf Figure 7.} {\bf {\it A.  thaliana} manhattan plot of $-\log(p{\rm -value})$ }. Population structure estimated by the APLS algorithm with $K=6$ ancestral populations and $\sigma = 1.5$ for the range parameter.
