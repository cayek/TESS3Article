...
\end{center}
\noindent{\bf Figure 5.} {\bf Parameter assessment for the APLS algorithm}. A) Empirical variogram of the {\it A. thaliana} genetics matrix. The red vertical line shows the spatial range $1.5$. B) Cross validation error as function of the number of ancestry coefficients $K$.
...
\end{center}
\noindent{\bf Figure 6.} {\bf {\it A. thaliana} ancestry coeficients}. Ancestry coeficient estimates computed by the APLS algorithm with $K=6$ ancestral populations and $\sigma = 1.5$ for the spatial range parameter A) Geographic map of ancestry coefficients. B) Barplot of ancestry coefficients.

\clearpage 
\newpage

\begin{center}
%\includegraphics[width=0.85\paperwidth]{../Figure5/Figures/manhattanplot.png}
\includegraphics{../Figure5/Figures/manhattanplot.pdf}
\end{center}
\noindent{\bf Figure 7.} {\bf {\it A.  thaliana} manhattan plot of $-\log(p{\rm -value})$ }. Population structure estimated by the APLS algorithm with $K=6$ ancestral populations and $\sigma = 1.5$ for the spatial range parameter.
