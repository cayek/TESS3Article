...
%The kriging analysis provided an approximate range of  $r = xx$km for the spatial variogram, which was consistent with the default parameter set for the geographic weights in the Laplacian matrix. 
