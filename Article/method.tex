...
\end{thm}
Thus, using AQP provides theoretical guarantees that the $Q$ and $G$-matrix estimates are correctly computed~\todo{pas assez precis}, a property lacking for other algorithms, such as {\tt structure} or {\tt tess3}. The AQP algorithm is thoroughly described in Algorithm~\ref{algo:aqp}.
