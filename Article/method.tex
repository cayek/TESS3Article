...
\label{eq:gamma}
\end{equation}
\noindent where $N(h)$ define all the indices of individuals separated by a geographic distance $h$. We can show that under the TESS3 model the function $\gamma$ can be approximated by 
\begin{equation}
